...
CREATE TABLE "new_home_settings" (
    ...
    "refreshInterval" REAL NOT NULL DEFAULT 6.0,
    "createdAt" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" DATETIME NOT NULL
);
INSERT INTO "new_home_settings" ("clockEnabled", "countdownEnabled", "countdownEventId", "createdAt", "eventsEnabled", "id", "kenBurnsIntensity", "latitude", "longitude", "mealsEnabled", "menuEnabled", "photoTransitionSpeed", "photosEnabled", "refreshInterval", "singletonId", "temperatureUnit", "todosEnabled", "updatedAt", "weatherEnabled") SELECT "clockEnabled", "countdownEnabled", "countdownEventId", "createdAt", "eventsEnabled", "id", "kenBurnsIntensity", "latitude", "longitude", "mealsEnabled", "menuEnabled", "photoTransitionSpeed", "photosEnabled", "refreshInterval", "singletonId", "temperatureUnit", "todosEnabled", "updatedAt", "weatherEnabled" FROM "home_settings";
